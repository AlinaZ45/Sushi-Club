...
function renderTableInventory(){
  const host=$('tableInventory'),summary=$('tableInventorySummary');
  ...
  host.innerHTML=ordered.length?ordered.map(tbl=>
    '<div class="inventory-card '+(tbl.active===false?'inactive':'')+'">'+
